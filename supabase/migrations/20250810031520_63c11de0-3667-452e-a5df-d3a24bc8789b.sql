-- Re-apply schema updates and schedule CRON using cron.schedule
create extension if not exists pg_cron with schema extensions;
create extension if not exists pg_net with schema extensions;

-- monday_files extra columns
...
-- CRON schedules using cron.schedule; ignore errors if already scheduled
