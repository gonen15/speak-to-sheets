...
DROP POLICY IF EXISTS ds_owner_all ON public.data_sources;
CREATE POLICY ds_owner_all ON public.data_sources
...
DROP POLICY IF EXISTS dsd_owner_sel ON public.data_source_datasets;
CREATE POLICY dsd_owner_sel ON public.data_source_datasets
